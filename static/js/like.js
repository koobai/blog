...
class EmojiReaction extends s {
  ...
  static styles = i$1`
    /* default light */
    .container {
      --start-smile-border-color-default: #eee;
      ...
      --reaction-got-reacted-bg-color-hover-default: #f6f6f6;
      --reaction-got-reacted-border-color-default: #ffdbc7;
      --reaction-got-reacted-text-color-default: #FC9151;
      --reaction-available-popup-bg-color-default: #fff;
      --reaction-available-popup-border-color-default: #eee;
      --reaction-available-popup-box-shadow-default: #8c959f33 0px 8px 24px 0px;
      --reaction-available-emoji-reacted-bg-color-default: transparent;
    ...
    .container-dark {
      ...
      --reaction-got-reacted-bg-color-default: #332D2F;
      --reaction-got-reacted-bg-color-hover-default: #433b3e;
      --reaction-got-reacted-border-color-default: transparent;
      --reaction-got-reacted-text-color-default: #FC9151;
      --reaction-available-popup-bg-color-default: #201d1e;
      --reaction-available-popup-border-color-default: #332D2F;
      --reaction-available-popup-box-shadow-default: #010409 0px 8px 24px 0px;
      --reaction-available-emoji-reacted-bg-color-default: transparent;
      --reaction-available-emoji-bg-color-hover-default: #433b3e;
      --reaction-available-emoji-z-index-default: 100;
      --reaction-available-mask-z-index-default: 80;
    }
    .anim-scale-in {
