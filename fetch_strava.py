...
def generate_monthly_ai_report(month_str, stats, prev_stats, current_day):
    ...
    3. 【必须包含“挑刺”环节】：你绝对不能只夸奖！必须一针见血地抓出本月数据的【最大短板】。例如：吐槽单次运动距离太短缺乏耐力；或吐槽某种低效运动（如徒步）占比过大而高强度（跑步/骑行）太少；或吐槽总出勤率太低；或吐槽心率一直在Z1舒适区等。（请挑最明显的一个短板来批评）
    4. 【专业减脂黑话】：请自然运用“运动容量”、“耐力基底”、“交叉训练”、“稳态燃脂(Z2)”、“心肺引擎”、“无效消耗”等专业词汇，体现你的严苛教练素养。
    5. 【结构要求】：先肯定高光亮点（如惊人的毅力/总里程/极限突破） -> 话锋一转，犀利指出多维度中的某项短板 -> 给出下个月具体的行动指令（如拉长单次距离、改变运动比例或提升心率）。
